-- Actualización de la función de recálculo de puntos de brackets para incluir la Ronda de 32 (Dieciseisavos)
...
BEGIN
    ...
    LOOP
        ...
        IF bp.round_of_32 IS NOT NULL AND teams_r32 IS NOT NULL THEN
            FOREACH t_id IN ARRAY teams_r32 LOOP
                IF bp.round_of_32 @> jsonb_build_array(t_id) THEN
